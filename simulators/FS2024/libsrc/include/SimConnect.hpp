...
SIMCONNECT_ENUM SIMCONNECT_DATATYPE:int
{
    ...
    SIMCONNECT_DATATYPE_INT8,           // 8-bit integer number, char
...
SIMCONNECT_ENUM SIMCONNECT_FLOW_EVENT : DWORD
{
...
SIMCONNECT_ENUM_FLAGS SIMCONNECT_COMM_BUS_BROADCAST_TO;
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_JS = 1 << 0;
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_WASM = 1 << 1;
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT = 1 << 3;
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT_SELF_CALL = 1 << 4; // need SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT, allow the client to broadcast to itself
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_DEFAULT = SIMCONNECT_COMM_BUS_BROADCAST_TO_JS | SIMCONNECT_COMM_BUS_BROADCAST_TO_WASM | SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT;
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_ALL_SIMCONNECT = SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT | SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT_SELF_CALL;
    static const DWORD SIMCONNECT_COMM_BUS_BROADCAST_TO_ALL = SIMCONNECT_COMM_BUS_BROADCAST_TO_JS | SIMCONNECT_COMM_BUS_BROADCAST_TO_WASM | SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT | SIMCONNECT_COMM_BUS_BROADCAST_TO_SIMCONNECT_SELF_CALL;
...
SIMCONNECT_ENUM SIMCONNECT_POSITION_REFERENTIAL
{
...
SIMCONNECT_REFSTRUCT SIMCONNECT_RECV_CAMERA_DATA : public SIMCONNECT_RECV
{
	SIMCONNECT_DATA_CAMERA CameraData;
};

SIMCONNECT_ENUM SIMCONNECT_CAMERA_WORLD_LOCKER_STATUS
{
...
SIMCONNECT_REFSTRUCT SIMCONNECT_RECV_CAMERA_WORLD_LOCKER : public SIMCONNECT_RECV
{
	SIMCONNECT_CAMERA_WORLD_LOCKER_STATUS Status;
};

SIMCONNECT_ENUM_FLAGS SIMCONNECT_CAMERA_DATA_MASK;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_NONE                              = 0;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_POSITION                          = 1 << 0;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_ROTATION                          = 1 << 1;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_TARGETED                          = 1 << 2;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_FOV                               = 1 << 3;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_ALL_ROTATION = SIMCONNECT_CAMERA_DATA_MASK_POSITION | SIMCONNECT_CAMERA_DATA_MASK_ROTATION | SIMCONNECT_CAMERA_DATA_MASK_FOV;
    static const DWORD    SIMCONNECT_CAMERA_DATA_MASK_ALL_TARGETED = SIMCONNECT_CAMERA_DATA_MASK_POSITION | SIMCONNECT_CAMERA_DATA_MASK_TARGETED | SIMCONNECT_CAMERA_DATA_MASK_FOV;

SIMCONNECT_ENUM SIMCONNECT_CAMERA_AVAILABILITY
{
...
SIMCONNECT_ENUM_FLAGS SIMCONNECT_CAMERA_FLAG;
    static const DWORD    SIMCONNECT_CAMERA_FLAG_INTERACTION    = 0x01;
    static const DWORD    SIMCONNECT_CAMERA_FLAG_ABOVE_GROUND   = 0x02;

SIMCONNECT_REFSTRUCT SIMCONNECT_RECV_CAMERA_STATUS : public SIMCONNECT_RECV
{
	DWORD acquiredState   = SIMCONNECT_CAMERA_NOT_ACQUIRED;
	BOOL  bGameControlled = false;
};
...
SIMCONNECT_REFSTRUCT SIMCONNECT_CAMERA_DEFINITION_ITEM
{
	SIMCONNECT_STRING(Str, 256);
};

SIMCONNECT_REFSTRUCT SIMCONNECT_RECV_CAMERA_DEFINITION_LIST : public SIMCONNECT_RECV_LIST_TEMPLATE
{
	SIMCONNECT_FIXEDTYPE_DATAV(SIMCONNECT_CAMERA_DEFINITION_ITEM, rgData, dwArraySize, U1 /*member of UnmanagedType enum*/, SIMCONNECT_CAMERA_DEFINITION_ITEM /*cli type*/);
};


SIMCONNECT_REFSTRUCT SIMCONNECT_RECV_COMM_BUS : public SIMCONNECT_RECV_LIST_TEMPLATE
{
    DWORD   uEventID;
...
SIMCONNECTAPI SimConnect_SubscribeToFlowEvent(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_UnsubscribeToFlowEvent(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_RequestAllFacilities(HANDLE hSimConnect, SIMCONNECT_FACILITY_LIST_TYPE type, SIMCONNECT_DATA_REQUEST_ID RequestID);
SIMCONNECTAPI SimConnect_CameraAcquire(HANDLE hSimConnect, const char * ClientId);
SIMCONNECTAPI SimConnect_CameraRelease(HANDLE hSimConnect, const char * CameraDefName);
SIMCONNECTAPI SimConnect_CameraGetStatus(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_CameraSet(HANDLE hSimConnect, SIMCONNECT_DATA_CAMERA CameraData, DWORD DataMask);
SIMCONNECTAPI SimConnect_CameraGet(HANDLE hSimConnect, DWORD Referential);
SIMCONNECTAPI SimConnect_CameraEnableFlag(HANDLE hSimConnect, DWORD Flag);
SIMCONNECTAPI SimConnect_CameraDisableFlag(HANDLE hSimConnect, DWORD Flag);
SIMCONNECTAPI SimConnect_SubscribeToCameraStatusUpdate(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_UnsubscribeToCameraStatusUpdate(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_EnumerateCameraDefinitions(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_CameraSetUsingCameraDefinition(HANDLE hSimConnect, const char * cameraDefinition);
SIMCONNECTAPI SimConnect_SubscribeToCommBusEvent(HANDLE hSimConnect, SIMCONNECT_CLIENT_EVENT_ID EventID, const char * EventName);
SIMCONNECTAPI SimConnect_UnsubscribeToCommBusEvent(HANDLE hSimConnect, SIMCONNECT_CLIENT_EVENT_ID EventID);
SIMCONNECTAPI SimConnect_CallCommBusEvent(HANDLE hSimConnect, const char * EventName, SIMCONNECT_COMM_BUS_BROADCAST_TO BroadcastTo, DWORD BufferSize, const char * Data);
SIMCONNECTAPI SimConnect_SubscribeToCameraWorldLockerStatusUpdate(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_UnsubscribeToCameraWorldLockerStatusUpdate(HANDLE hSimConnect);
SIMCONNECTAPI SimConnect_RequestCameraWorldLocker(HANDLE hSimConnect, SIMCONNECT_DATA_XYZ lockerPosition, SIMCONNECT_POSITION_REFERENTIAL referential, DWORD objectId);
SIMCONNECTAPI SimConnect_DeleteCameraWorldLocker(HANDLE hSimConnect);
